...
#define coef	monomial.data.second
	...
	while (thead1 != nullptr)
	{
		while (thead2 != nullptr)
		{
			...
			{
				throw std::logic_error("The degree is too high");//слишком большая степень
			}
...
polinom& polinom::operator=(const polinom& p)
{
	...
	while (thead1 != nullptr)
	{
		...
		if (thead2 == nullptr)
		{
			thead2 = new listMonomial(thead1->monomial);
		}
		else
		{
			thead2->monomial = thead1->monomial;
		}
		thead1 = thead1->next;
	}
